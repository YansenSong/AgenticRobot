...
class Room:
    ...
    def infer_room_type_from_view_embedding(
        ...
        """
        Use the embeddings stored inside the room to infer room type.

        We should already save k views CLIP embeddings for each room. We match the k
    ...
    def infer_room_type_from_room_name(
        ...
        """
        # import sys
        # sys.path.append("${HOLOAGENT_DATA_ROOT}/hovsg/HOV-SG/hmsg/utils")
