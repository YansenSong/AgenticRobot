...
class SemGaussianModel(GaussianModel):
    ...
    def densification_postfix(
        ...
        if new_obj_idxs is None:
            ...
            new_obj_idxs = torch.cat((self._obj_ids, torch.ones(
                (n_new_gaussians, 1), device="cuda", dtype=torch.int32) * (-1)), dim=0)
