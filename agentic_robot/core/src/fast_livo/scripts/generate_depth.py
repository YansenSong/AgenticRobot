...
#     input_dir = "${HOLOAGENT_DATA_ROOT}/3D_Recon/datasets/G1/rosbag2_2025_07_18-19_16_33_new/sfm/sparse/0"
#     output_dir= "${HOLOAGENT_DATA_ROOT}/3D_Recon/datasets/G1/rosbag2_2025_07_18-19_16_33_new/depth"
#     vis_output_dir= "${HOLOAGENT_DATA_ROOT}/3D_Recon/datasets/G1/rosbag2_2025_07_18-19_16_33_new/vis_depth"
#     images_file = os.path.join(input_dir, "poses.txt")
#     camera_file = os.path.join(input_dir, "cameras.txt")
#     keyframe_dir = "${HOLOAGENT_DATA_ROOT}/3D_Recon/datasets/G1/rosbag2_2025_07_18-19_16_33_new/PCD"
#     traj_kf_file="${HOLOAGENT_DATA_ROOT}/3D_Recon/datasets/G1/rosbag2_2025_07_18-19_16_33_new/PCD/scans_pos.txt"
#     # keyframe_dir = "${HOLOAGENT_DATA_ROOT}/3D_Recon/datasets/G1/rosbag2_2025_04_08-21_29_56_fast_livo/PCD"
#     # traj_kf_file="${HOLOAGENT_DATA_ROOT}/3D_Recon/datasets/G1/rosbag2_2025_04_08-21_29_56_fast_livo/PCD/scans_pos.txt"
#     # 检查文件是否存在
...
#         # # 读取对应的 RGB 图像作为输入图像
#         rgb_image_path = '${HOLOAGENT_DATA_ROOT}/3D_Recon/datasets/G1/rosbag2_2025_07_18-19_16_33_new/images'
...
def main():
    input_dir = "${HOLOAGENT_DATA_ROOT}/VLN/dataset/hts_demo_outdoor/Colmap/sparse/0"
    output_dir = "${HOLOAGENT_DATA_ROOT}/VLN/dataset/hts_demo_outdoor/Colmap/depth"
    rgb_image_path = '${HOLOAGENT_DATA_ROOT}/VLN/dataset/hts_demo_outdoor/Colmap/images'
    vis_output_dir = "${HOLOAGENT_DATA_ROOT}/VLN/dataset/hts_demo_outdoor/Colmap/vis_depth"
    images_file = os.path.join(input_dir, "poses.txt")
    camera_file = os.path.join(input_dir, "cameras.txt")
    keyframe_dir = "${HOLOAGENT_DATA_ROOT}/VLN/dataset/hts_demo_outdoor/PCD"
    traj_kf_file = "${HOLOAGENT_DATA_ROOT}/VLN/dataset/hts_demo_outdoor/PCD/scans_pos.json"
